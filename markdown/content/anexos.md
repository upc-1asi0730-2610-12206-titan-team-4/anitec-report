...
- Exposicion AV2: [Video de exposicion](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202315165_upc_edu_pe/IQBNbZRIWFzfSZQT4mSa7cCyAa-felpel01CsMzjW-O3eFg?nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D&e=BKHhcW)
...
- Repositorio del backend web: [GitHub - anitec-backend](https://github.com/upc-1asi0730-2610-12206-titan-team-4/anitec-backend)
...
- Despliegue del frontend web: [GitHub Pages](https://upc-1asi0730-2610-12206-titan-team-4.github.io/anitec-frontend)
- Despliegue del backend web: [Render](https://anitec-backend.onrender.com/swagger/index.html)
...
- GitHub Pages, para despliegue de la landing page y frontend web: [Sitio oficial](https://pages.github.com)
- Render, para despliegue del backend web: [Sitio oficial](https://render.com/)
- My JSON Server, para datos de prueba: [Sitio oficial](https://my-json-server.typicode.com/)
